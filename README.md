<div align="center">
    <div style="margin-bottom: 15px">
        <a href="https://github.com/openivity/openivity.github.io">
            <img src="docs/images/openivity-header.svg" alt="Logo" height="80">
        </a>
    </div>
    <hr>
...
Open Activity, also known as Openivity, is a free and open-source analytic platform offering seamless integration with OpenStreetMap. Effortlessly visualize, edit, convert, and combine multiple FIT, GPX, and TCX activity files. Enjoy the full power of client-side processing for first-class privacy. Try right away at [https://openivity.github.io](https://openivity.github.io).

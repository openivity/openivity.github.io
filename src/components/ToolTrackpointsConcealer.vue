  ...
  <div>
    ...
    <div class="collapse show" id="concealTarget">
      <p>
        ...
        activity on social media, like Strava, and you want to avoid revealing the exact location of
        your home for security reasons and you wouldn't want your information stored on any
        platform's server.
      </p>
    </div>
